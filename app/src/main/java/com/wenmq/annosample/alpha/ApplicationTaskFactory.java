...
import com.wenmq.annosample.MyApplication;
...
//    @MPoster(receptorAddress = "App")
//    @AutoBowArrow(target = "application", context = true)
//    public static class TaskA extends Task implements IAutoBowArrow {
//        public TaskA() {
//            super("taskA");
//        }
//
